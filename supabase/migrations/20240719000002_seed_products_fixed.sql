...
VALUES
  (gen_random_uuid(), 'Home Jersey 2024/25', 'Official home jersey for the 2024/25 season', 89.99, 'https://images.unsplash.com/photo-1580087256394-dc596e1c8f4f?w=800&q=80', 'jerseys', ARRAY['S', 'M', 'L', 'XL', 'XXL'], '["Red", "White"]'::jsonb, true),
  (gen_random_uuid(), 'Away Jersey 2024/25', 'Official away jersey for the 2024/25 season', 89.99, 'https://images.unsplash.com/photo-1571537644077-5451c3a28abb?w=800&q=80', 'jerseys', ARRAY['S', 'M', 'L', 'XL', 'XXL'], '["Blue", "Black"]'::jsonb, true),
  (gen_random_uuid(), 'Third Kit 2024/25', 'Official third kit for the 2024/25 season', 94.99, 'https://images.unsplash.com/photo-1565377025535-c897f5f71133?w=800&q=80', 'jerseys', ARRAY['S', 'M', 'L', 'XL'], '["Green", "Gold"]'::jsonb, true),
  (gen_random_uuid(), 'Goalkeeper Jersey 2024/25', 'Official goalkeeper jersey for the 2024/25 season', 99.99, 'https://images.unsplash.com/photo-1594476664296-8c552d551161?w=800&q=80', 'jerseys', ARRAY['M', 'L', 'XL', 'XXL'], '["Black", "Yellow"]'::jsonb, true);
...
INSERT INTO products (id, name, description, price, image, category, sizes, colors, in_stock)
VALUES
  (gen_random_uuid(), 'Home Shorts 2024/25', 'Official home shorts for the 2024/25 season', 39.99, 'https://images.unsplash.com/photo-1591195853828-11db59a44f6b?w=800&q=80', 'shorts', ARRAY['S', 'M', 'L', 'XL'], '["Red", "White"]'::jsonb, true),
  (gen_random_uuid(), 'Away Shorts 2024/25', 'Official away shorts for the 2024/25 season', 39.99, 'https://images.unsplash.com/photo-1562886877-3a0d4944103e?w=800&q=80', 'shorts', ARRAY['S', 'M', 'L', 'XL'], '["Blue", "Black"]'::jsonb, true),
  (gen_random_uuid(), 'Training Shorts', 'Lightweight shorts for training sessions', 29.99, 'https://images.unsplash.com/photo-1571078580234-327eda3b2fc0?w=800&q=80', 'shorts', ARRAY['S', 'M', 'L', 'XL'], '["Black", "Gray"]'::jsonb, true);
